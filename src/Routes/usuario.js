...
function conectar(){
    const mysqlConnection = mysql.createConnection({
        ...
        ssl:{
            ...
            "3MIIDrzCCApegAwIBAgIQCDvgVpBCRrGhdWrJWZHHSjANBgkqhkiG9w0BAQUFADBh"+
...
router.post('/Soporte', (req, res)=>{
    ...
    try{
        ...
        '<table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">'+
        '<tr>'+
        '<td align="left" style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, \'helvetica neue\', helvetica, sans-serif;line-height:28px;color:#000000;font-size:14px">Se hizo el pedido de seguimiento de una duda para el sistema, responde de la manera más rapida posible</p></td>'+
        '</tr>'+
        '<tr>'+
